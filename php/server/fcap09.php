...
<script type="text/javascript">
     $(document).ready(function() {
       var suche = $("input[name='Suche1']").val();
	   var page =$("input[name='Page']").val();
       $("tbody").load("refresh_fcap09.php?suche=" + suche + "&page=" + page);
       
	   $("input[name='Suche1']").change(function(){
			var suche = $(this).val();
			$("tbody").load("refresh_fcap09.php?suche=" + suche + "&page=" + page);
	   });
...
<div id="content">
	...
	<div class="input-prepend">
		...
		<input class="span2" type="text" placeholder="Suche" id="Suche" name="Suche1">
	</div>
	<br /><br /><br />
	<!-- Trennlinie --> 
	<hr class="hr_title">	
